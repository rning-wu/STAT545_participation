...
|-----------------------|-------------------------|
| **data**              | `gapminder`             |
| **aesthetic mapping** | `x` and `y` coordinates |
...
``` r
## Commented out to allow knit to run
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-15-1.png) 4. How does the grammar differ from a box plot or violin plot? - ANSWER:
